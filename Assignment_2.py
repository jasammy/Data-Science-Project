...
def answer_seven():
    ...
    ans = Top15[Top15['Ratio'] == max(Top15['Ratio'])]
...
def answer_eight():
    ...
    desc = Top15['Population'].sort_values(ascending=False)
    return desc.index.tolist()[2]
...
def answer_nine():
    ...
    ans = pearsonr(Top15['Citable docs per Capita'],Top15['Energy Supply per Capita'])
    return ans[0]
